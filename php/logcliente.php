...
include 'cabecera.inc';
	...
	$consulta = "SELECT * FROM clientes WHERE usuario= '".$_POST['usuario']."' AND contrasena = '".$_POST['contrasena']."'";
	...
	if($contador > 0 ){
		...
		for($i=0; $i < $_SESSION['contador'];$i++){
			$consulta ="INSERT INTO lineaspedido VALUES (NULL,'".$_SESSION['idpedido']."','".$_SESSION['producto'][$i]."','1')";
			$resultado = mysqli_query($conn,$consulta);
